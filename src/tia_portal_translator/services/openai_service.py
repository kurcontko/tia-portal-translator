...
class OpenAITranslationService(TranslationService):
    """Modern OpenAI translation service using tenacity for API retries with a single base attempt."""
    ...
    def __init__(
        ...
        Args:
            ...
            max_retries: Maximum retry attempts for failed OpenAI API requests (base loop is single-attempt)
    ...
    def _get_retry_attempts(self) -> int:
        """OpenAI uses tenacity retries; keep the base loop to a single attempt."""
        return 1
